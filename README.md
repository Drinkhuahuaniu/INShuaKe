...
INShuaKe是使用PYTHON语言编写的**免费**SHUAKE工具，只限于HN、BJ地区，BJ地区请移步https://github.com/Sangdi-IT/shuake
...
- January 6,2026 更新网页元素位置变动的导致软件运行失败，简单优化过验证码def,修复不同分辨率导致的滑块位置计算数值偏差
- January 11,2026 加入数据库记录课程进度，避免重复读取课程浪费时间
